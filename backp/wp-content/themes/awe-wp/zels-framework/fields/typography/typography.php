 ...
 *
 */
class Zels_Framework_Option_typography extends Zels_Framework_Options {
  ...
  public function output() {
    ...
    $default_variants = apply_filters( 'zels_websafe_fonts_variants', array(
      'regular',
      'italic',
      '700',
      '700italic',
    ...
    $websafe_fonts = apply_filters( 'zels_websafe_fonts', array(
      'Arial',
      'Arial Black',
      'Comic Sans MS',
      'Impact',
