 ...
 *
 */
class Zels_Framework_Option_Sorter extends Zels_Framework_Options {
  ...
  public function output(){
    ...
    $enabled_title  = ( isset( $this->field['enabled_title'] ) ) ? $this->field['enabled_title'] : __( 'Enabled Modules', ZELS_TEXTDOMAIN );
    $disabled_title = ( isset( $this->field['disabled_title'] ) ) ? $this->field['disabled_title'] : __( 'Disabled Modules', ZELS_TEXTDOMAIN );

    echo '<div class="zels-modules">';
    echo '<h3>'. $enabled_title .'</h3>';
    echo '<ul class="zels-enabled">';
    if( ! empty( $enabled ) ) {
