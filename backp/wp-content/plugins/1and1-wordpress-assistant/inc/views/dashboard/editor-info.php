...
<div id="assistant-editor-info-panel" class="dashboard-column dashboard-column1 welcome-panel assistant-dashboard-panel">
	...
	<div class="inside">
		<div class="dashboard-panel-title">
			<h2><?php _e( 'The new Editor is here!', '1and1-wordpress-wizard' ); ?></h2>
            <p class="about-description"><?php _e( 'WordPress 5.0 is here and so is Gutenberg.', '1and1-wordpress-wizard' ); ?></p>
                ...
                <?php if ( $article1_link ): ?>
                    <li>
                        <a href="<?php echo $article1_link; ?>" target="_blank">
                            <?php _e( 'Learn more about the Gutenberg editor', '1and1-wordpress-wizard' ); ?>
                        </a>
                    </li>
                <?php endif; ?>
	            <?php if ( $article2_link ): ?>
                    <li>
                        <a href="<?php echo $article2_link; ?>" target="_blank">
                            <?php _e( 'How do we deal with it?', '1and1-wordpress-wizard' ); ?>
                        </a>
                    </li>
                <?php endif; ?>
            </ul>
            <div style="clear:both;">
                <a class="button install-plugin" data-plugin="classic-editor" href="#">
                    <span class="setup"><?php _e( 'Switch back to the old Editor', '1and1-wordpress-wizard' ); ?></span>
